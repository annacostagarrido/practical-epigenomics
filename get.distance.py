...
for line in open_input.readlines(): # for each line in the input file
	...
	dif = abs(position - enhancer_start) # compute the absolute value of the difference between position and enhancer_start
	
	if dif < x: # if this absolute value is lower than x
		x = dif # this value will now be your current x
